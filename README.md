...
This is my Neovim configuration based on [NVChad](https://nvchad.com/) There's some AI integration that, by default, is setup to work with a GitHub Copilot subscription, but can work with other adapters and models as well. I have set up a note-taking system with Telekasten, with various plugins for making markdown look nice. I use a Catppuccin Mocha theme that I've tweaked to make plaintext more legible here and there.
